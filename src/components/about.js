  ...
  return (
    <div>
      ...
      <div className="card text-centre">
        <h6 style={{ marginTop: "1rem" }}>BECAUSE IT STILL TAKES A VILLAGE:</h6>
        <div className="card-title">What is Drea Day?</div>
        <div className="card-body">
          <span className="text-muted" style={{ marginBottom: "1rem" }}>
      ...
      <h3 style={{ marginTop: "1rem" }}>Our Partners</h3>
      <div className="container1" style={{ marginTop: "2rem" }}>
